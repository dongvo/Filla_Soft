...
import { SimpleNotificationsService } from './simple-notifications.service';
...
@Component({
    ...
    styleUrls: [
        './simple-notifications.component.scss'
    ]
})
...
export class SimpleNotificationsComponent implements OnInit, OnDestroy {
    ...
    constructor(private _service: SimpleNotificationsService) { }
